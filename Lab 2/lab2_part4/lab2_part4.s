#--------------------------------------------------------------------------
# ELEC 371 Laboratory 2 Part 4 Assembly Code
# Fall 2018
# Author: Tom Sung
...
do_while_getchar:
	ldwio	r4, DATA_OFFSET(r3)		# r3 is JTAG data register
	andi	r5, r4, RAVLID
	beq		r5, r0, do_while_getchar
...
# save registers
	...
	stw		r4,	4(sp)
	movia	r3, JTAG_UART_BASE
# do while loop: read JTAG UART status register, and it with 0xFFFF0000 while wspace is 0
	
pc_loop:
	ldwio	r4, STATUS_OFFSET(r3)
	andhi	r4,	r4, WSPACE_MASK
	beq		r4, r0, pc_loop
	stwio	r2, DATA_OFFSET(r3)		# r2 contains character
	ldw		r3, 0(sp)
	ldw		r4, 4(sp)
	addi	sp, sp, 8
...
# toggle the hex displays
	movia	r2, DISPLAY
	ldwio	r3, 0(r2)	# read what display is on
	stwio	r0, 0(r2)
	
	beq		r3, r0, state1	#if nothing was on
...
isr_buttons:
# clear button interrupt when ipending bit is 1
#   wrctl   ipending,r0
